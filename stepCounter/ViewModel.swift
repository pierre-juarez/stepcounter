...
final class ViewModel: ObservableObject {
    ...
    func getMySteps(){
        ...
        let predicate = HKStatisticsQuery.predicateForSamples(withStart: startDay, end: now, options: .strictStartDate)
        
        self.query = HKStatisticsQuery(quantityType: stepsQuantityType, quantitySamplePredicate: predicate, options: .cumulativeSum, completionHandler: { _, result, _ in
